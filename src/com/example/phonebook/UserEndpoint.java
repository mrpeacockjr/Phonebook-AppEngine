...
@Api(name = "userendpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath = "phonebook"))
public class UserEndpoint {
	...
	public CollectionResponse<User> listUser(
		...
		//Logger.
		System.out.println("Begin userEndpoint listUser");
		try {
		...
		System.out.println("End userEndpoint listUser");
